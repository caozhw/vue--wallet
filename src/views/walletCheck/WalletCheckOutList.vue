    ...
    <el-col :span="24" class="" style="padding-bottom: 0px;margin-top: 0;">
      <el-table :data="listData" :row-style="rowColor"   :fit="tableFit" highlight-current-row border   style="width: 100%;" 
        ...
        <el-table-column prop="uid" label="UID" width="80"  align="center" >
         ...
         <el-table-column prop="transMoney" label="交易平台提币总量" width="80" align="right" :formatter="namberFormatter">
        </el-table-column>
        <el-table-column prop="walletMoney" label="钱包系统提币总量" width="80" align="right" :formatter="namberFormatter">
        </el-table-column>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      verify(){//确认审核
        let params = {
           api_method:'WalletCheckOutAudit',
           audit_status:2,
           ids:this.ids
        };
      ...
      export(){
        ...
        params.api_method = 'WalletCheckOutListExp';
        params.page_number = 1;
        params.page_size = this.exportNumber;
        exportApi(params).then((res) => {
         if(res){
            this.form.api_method = 'WalletCheckOutList'; 
            this.$message({
              message: '导出成功',
              type: 'success'
            });
