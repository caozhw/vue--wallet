    ...
    <section>
      ...
      <el-row class="detail-row">
       ...
       <el-row class="detail-row">
        ...
        <el-col :span="10" class="detail-value">{{baseTypeFormatter(datailData.address)}}</el-col>
      ...
      <el-row class="detail-row">
        ...
        <el-col :span="10" class="detail-value">{{datailData.auditUid}}</el-col>
        <el-col :span="2" class="detail-label">审核备注</el-col>
        <el-col :span="10" class="detail-value">{{datailData.remark}}</el-col>
      </el-row>
      <el-row class="detail-row">
        ...
        <el-col :span="10" class="detail-value">{{timeFormatter(datailData.transTime)}}</el-col>
      </el-row>
